...
MACRO(ADD_SERVER_MANAGER_EXTENSION OUTSRCS Name Version XMLFile)
  ...
  IF(PARAVIEW_PROCESS_XML_EXECUTABLE)
    FOREACH(TMPXML ${XMLFile})
      ...
      SET(XML_FILES ${XML_FILES} ${TMP_XML_FILE})
      SET(PUSH_BACK_XML_INTERFACES 
        "${PUSH_BACK_XML_INTERFACES} xmls.push_back(${XML_IFACE_PREFIX}${XML_NAME}${XML_IFACE_GET_METHOD}());\\\n")
      SET(HAVE_XML 1)
    ENDFOREACH(TMPXML)
...
MACRO(ADD_PARAVIEW_GRAPH_LAYOUT_STRATEGY OUTIFACES OUTSRCS)
  ...
  CONFIGURE_FILE(${ParaView_SOURCE_DIR}/Qt/Core/pqGraphLayoutStrategyImplementation.h.in
                 ${CMAKE_CURRENT_BINARY_DIR}/${ARG_STRATEGY_TYPE}Implementation.h @ONLY)
  CONFIGURE_FILE(${ParaView_SOURCE_DIR}/Qt/Core/pqGraphLayoutStrategyImplementation.cxx.in
...
MACRO(ADD_PARAVIEW_TREE_LAYOUT_STRATEGY OUTIFACES OUTSRCS)
  ...
  CONFIGURE_FILE(${ParaView_SOURCE_DIR}/Qt/Core/pqTreeLayoutStrategyImplementation.h.in
                 ${CMAKE_CURRENT_BINARY_DIR}/${ARG_STRATEGY_TYPE}Implementation.h @ONLY)
  CONFIGURE_FILE(${ParaView_SOURCE_DIR}/Qt/Core/pqTreeLayoutStrategyImplementation.cxx.in
                 ${CMAKE_CURRENT_BINARY_DIR}/${ARG_STRATEGY_TYPE}Implementation.cxx @ONLY)
...
FUNCTION(ADD_PARAVIEW_PLUGIN NAME VERSION)
  ...
  PV_PLUGIN_PARSE_ARGUMENTS(ARG 
    "SERVER_MANAGER_SOURCES;SERVER_MANAGER_XML;SERVER_SOURCES;PYTHON_MODULES;GUI_INTERFACES;GUI_RESOURCES;GUI_RESOURCE_FILES;GUI_SOURCES;SOURCES;REQUIRED_PLUGINS;REQUIRED_ON_SERVER;REQUIRED_ON_CLIENT"
    "" ${ARGN} )
  ...
  IF(GUI_SRCS OR SM_SRCS OR ARG_SOURCES OR ARG_PYTHON_MODULES)
    ...
    CONFIGURE_FILE(
      ${ParaView_SOURCE_DIR}/CMake/pqParaViewPlugin.h.in
      ${CMAKE_CURRENT_BINARY_DIR}/${PLUGIN_NAME}_Plugin.h @ONLY)
    CONFIGURE_FILE(
      ${ParaView_SOURCE_DIR}/CMake/pqParaViewPlugin.cxx.in
