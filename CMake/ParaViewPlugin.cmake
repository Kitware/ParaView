...
Allows plugins to add one or more QActionGroup instances to either a menu or a toolbar.
The GROUP_NAME must follow the format "TypeName/MenuName", where TypeName can be
either "MenuBar" or "ToolBar".
If the specified MenuName already exists, the macro will append the actions to
the existing menu or toolbar, inserting a separator between the new and existing actions.
...
```
  ...
  * `GROUP_NAME`: The name of the action group, must follow the format "TypeName/MenuName",
    where TypeName can be either "MenuBar" or "ToolBar".
  * `INTERFACES`: The name of the generated interface.
  * `SOURCES`: The source files generated by the interface.
#]==]
