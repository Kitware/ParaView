...
// make 10 calls to vtkKWPushButton::New(), 10 calls to Create(), and 10 
// calls to Delete(): just create one instance of a vtkKWPushButtonSet, then 
// call vtkKWPushButtonSet::AddWidget to automatically allocate and create an
...
// \subpage kwwidgets_autogenerated_page "Auto-Generated Classes" page. 
