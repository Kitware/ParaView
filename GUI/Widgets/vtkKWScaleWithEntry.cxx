...
vtkCxxRevisionMacro(vtkKWScaleWithEntry, "1.1");
...
//---------------------------------------------------------------------------
void vtkKWScaleWithEntry::Create(vtkKWApplication *app)
{
...
//----------------------------------------------------------------------------
void vtkKWScaleWithEntry::CreateEntry(vtkKWApplication *app)
{
...
void vtkKWScaleWithEntry::SetEntryVisibility(int _arg)
{
  ...
  if (this->EntryVisibility && this->IsCreated())
    {
    this->CreateEntry(this->GetApplication());
    }
...
//---------------------------------------------------------------------------
void vtkKWScaleWithEntry::UpdateEntryValue()
{
  if (this->Entry && this->Entry->IsCreated())
    {
...
{
  if (this->EntryCommand && !this->GetDisableCommands() && this->IsCreated())
    {
