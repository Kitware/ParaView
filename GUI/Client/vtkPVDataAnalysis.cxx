...
vtkCxxRevisionMacro(vtkPVDataAnalysis, "1.3.2.1");
//-----------------------------------------------------------------------------
...
void vtkPVDataAnalysis::CreateProperties()
{
  ...
  this->PlotParametersFrame->Create(app);
  ...
  this->ShowXYPlotCheckButton->Create(app);
  ...
  this->PlotOverTimeCheckButton->Create(app);
  ...
  this->ArraySelectionFrame->Create(app);
  ...
  this->TemporalParametersFrame->Create(app);
  ...
  this->LockTemporalCacheCheckButton->Create(app);
  ...
  this->PlotDisplayPropertiesFrame->Create(app);
  ...
  this->PlotTitleYPositionWidget->Create(app);
  ...
  this->LegendLabel->SetParent(
    this->PlotDisplayPropertiesFrame->GetFrame());
  this->LegendLabel->Create(app);
  this->LegendLabel->SetText("Legend ");

  this->ShowLegendCheckButton->SetParent(
    this->PlotDisplayPropertiesFrame->GetFrame());
  this->ShowLegendCheckButton->Create(app);
  this->ShowLegendCheckButton->SetSelectedState(1);
  this->ShowLegendCheckButton->SetCommand(this, "LegendVisibilityCallback");
  ...
  this->LegendXPositionWidget->SetParent(
    this->PlotDisplayPropertiesFrame->GetFrame());
  this->LegendXPositionWidget->Create(app);
  ...
  this->LegendYPositionWidget->SetParent(
    this->PlotDisplayPropertiesFrame->GetFrame());
  this->LegendYPositionWidget->Create(app);
  ...
  this->DataInformationFrame->Create(app);
  ...
  this->DataInformationList->Create(app);
...
//-----------------------------------------------------------------------------
void vtkPVDataAnalysis::SetPlotOverTime(int state)
{
  this->GetTraceHelper()->AddEntry(
    "$kw(%s) SetPlotOverTime %d", this->GetTclName(), state);
...
//-----------------------------------------------------------------------------
void vtkPVDataAnalysis::PlotOverTimeCheckButtonCallback()
{
  int state = this->PlotOverTimeCheckButton->GetSelectedState();
  this->SetPlotOverTime(state);
}

//-----------------------------------------------------------------------------
void vtkPVDataAnalysis::LockTemporalCacheCheckButtonCallback()
{
  this->SetLockTemporalCache(
    this->LockTemporalCacheCheckButton->GetSelectedState());
}

//-----------------------------------------------------------------------------
void vtkPVDataAnalysis::SetLockTemporalCache(int state)
{
  this->GetTraceHelper()->AddEntry(
    "$kw(%s) SetLockTemporalCache %d",
    this->GetTclName(), state);
...
void vtkPVDataAnalysis::AcceptCallbackInternal()
{
  ...
  if (!initialized)
    ...
    this->PointArraySelection->Create(app);
    ...
    this->CellArraySelection->SetColorProperty(
      vtkSMDoubleVectorProperty::SafeDownCast(
        this->PlotDisplayProxy->GetProperty("PlotColors")));
    this->CellArraySelection->Create(app);
    }
...
void vtkPVDataAnalysis::AppendData(int point_data, int index, vtkFieldData* fieldData)
{
  ...
  for (int i = 0; i < numArrays; i++)
    ...
    switch (array->GetDataType())
      {
      vtkTemplateMacro(::vtkPVDataAnalysisPrintTuple(stream,
    ...
    data_type << num_of_components << " - "
              << vtkImageScalarTypeNameMacro(array->GetDataType());
...
//-----------------------------------------------------------------------------
void vtkPVDataAnalysis::PlotTitleCallback()
{
  this->SetPlotTitle(this->PlotTitleEntry->GetValue());
}
...
//-----------------------------------------------------------------------------
void vtkPVDataAnalysis::AdjustTitlePositionCallback()
{
  this->SetAdjustTitlePosition(
    this->AdjustTitlePositionCheckButton->GetSelectedState());
}
...
//-----------------------------------------------------------------------------
void vtkPVDataAnalysis::XAxisLabelCallback()
{
  this->SetXAxisLabel(this->XLabelEntry->GetValue());
}
...
//-----------------------------------------------------------------------------
void vtkPVDataAnalysis::YAxisLabelCallback()
{
  this->SetYAxisLabel(this->YLabelEntry->GetValue());
}
...
//-----------------------------------------------------------------------------
void vtkPVDataAnalysis::LegendPositionCallback()
{
  double pos[2];
...
//-----------------------------------------------------------------------------
void vtkPVDataAnalysis::LegendVisibilityCallback()
{
  this->SetLegendVisibility(this->ShowLegendCheckButton->GetSelectedState());
}
...
void vtkPVDataAnalysis::EditXLabelCallback(int popup_dialog)
{
  ...
  if (!this->LabelPropertiesDialog)
    ...
    this->LabelPropertiesDialog->Create(this->GetPVApplication());
