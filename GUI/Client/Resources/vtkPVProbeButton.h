 ...
 */
#define image_PVProbeButton_width         32
#define image_PVProbeButton_height        32
#define image_PVProbeButton_pixel_size    3
#define image_PVProbeButton_buffer_length 432
