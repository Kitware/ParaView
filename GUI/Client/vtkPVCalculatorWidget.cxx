...
vtkPVCalculatorWidget::vtkPVCalculatorWidget()
{
  ...
  this->CalculatorFrame = vtkKWFrameWithLabel::New();
...
void vtkPVCalculatorWidget::CreateWidget()
{
  ...
  this->AttributeModeLabel->Create();
  ...
  this->ButtonLeftParenthesis->Create();
  ...
  this->ButtonRightParenthesis->Create();
