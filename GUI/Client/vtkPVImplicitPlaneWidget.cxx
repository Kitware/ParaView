...
vtkPVImplicitPlaneWidget::vtkPVImplicitPlaneWidget()
{
  ...
  this->NormalButtonFrame = vtkKWFrame::New();
...
//----------------------------------------------------------------------------
void vtkPVImplicitPlaneWidget::ChildCreate()
{
