...
# ADD CPP /nologo /MD /W3 /GX /O2 /I "C:\program files\html help workshop\include" /I "..\..\vtkbin" /I "..\..\vtk\common" /I "..\..\vtk\graphics" /I "..\..\vtk\imaging" /I "..\..\vtk\contrib" /I "..\..\vtk\pcmaker\xlib" /D "NDEBUG" /D "_USRDLL" /D "Widgets_EXPORTS" /D "WIN32" /D "_WINDOWS" /D "_MBCS" /D "VTKDLL" /YX /FD /Zm1000 /c
...
# ADD LINK32 ..\..\vtk\pcmaker\tk82.lib ..\..\vtk\pcmaker\tcl82.lib ..\..\vtkbin\vtktcl\vtktcl.lib ..\..\vtkbin\vtkdll\vtkdll.lib htmlhelp.lib kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /dll /machine:I386 /out:"Release/vtkKWWidgetsTcl.dll" /libpath:"C:\program files\html help workshop\lib"
...
# ADD CPP /nologo /MDd /W3 /Gm /GX /ZI /Od /I "C:\program files\html help workshop\include" /I "..\..\vtkbin" /I "..\..\vtk\common" /I "..\..\vtk\graphics" /I "..\..\vtk\imaging" /I "..\..\vtk\contrib" /I "..\..\vtk\pcmaker\xlib" /D "_DEBUG" /D "_USRDLL" /D "Widgets_EXPORTS" /D "WIN32" /D "_WINDOWS" /D "_MBCS" /D "VTKDLL" /YX /FD /GZ /Zm1000 /c
...
SOURCE=.\vtkKWLabeledEntry.cxx
# End Source File
# Begin Source File

SOURCE=.\vtkKWLabeledEntryTcl.cxx
# End Source File
# Begin Source File
...
SOURCE=.\vtkKWOKCancelDialog.cxx
# End Source File
# Begin Source File

SOURCE=.\vtkKWOKCancelDialogTcl.cxx
# End Source File
# Begin Source File
...
# Begin Custom Build
InputPath=.\vtkKWLabeledEntry.h
InputName=vtkKWLabeledEntry
...
SOURCE=.\vtkKWOKCancelDialog.h

!IF  "$(CFG)" == "Widgets - Win32 Release"

# Begin Custom Build
InputPath=.\vtkKWOKCancelDialog.h
InputName=vtkKWOKCancelDialog
