...
::
nmake -nologo -f makefile.vc release dlls OPTS=symbols,static,msvcrt install
if errorlevel 1 goto error
...
::
nmake -nologo -f makefile.vc release dlls OPTS=symbols,static,msvcrt,threads install
if errorlevel 1 goto error
