...
if __name__ == "__main__":
    ...
    parser.add_argument("--ds-host", default="", help="Hostname to connect to for DataServer", dest="dsHost")
    parser.add_argument("--ds-port", default=11111, type=int, help="Port number to connect to for DataServer", dest="dsPort")
    parser.add_argument("--rs-host", default="", help="Hostname to connect to for RenderServer", dest="rsHost")
