...
![Path tracer combined with typical visualization capabilities](img/5.5.0/ospray_path_tracing.png)
Path tracer combined with typical visualization capabilities.
...
Data and picture credit: [http://www.dkrz.de/](DKRZ).
...
![Exploded rock view from the DigitalRockPhysics plugin](digital_rock_physics.png)
