...
## VTKHDF Writer: support new types

ParaView can now write HyperTree Grid, Structured Grid, Rectilinear Grid and ImageData datasets to disk in .vtkhdf.

HyperTree Grids can be written in parallel.
