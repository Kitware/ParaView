...
elseif ("$ENV{CMAKE_CONFIGURATION}" MATCHES "macos")
  ...
  set(qt_abi "clang_64")
elseif ("$ENV{CMAKE_CONFIGURATION}" MATCHES "^(el|fedora)")
...
# Directories for addons.
set(qt_addon_directory_for_qt5compat ".addons.qt5compat")
set(qt_addon_directory_for_qtmultimedia ".addons.qtmultimedia")
set(qt_addon_directory_for_qtwebchannel ".addons.qtwebchannel")
set(qt_addon_directory_for_qtwebsockets ".addons.qtwebsockets")
set(qt_addon_directory_for_qtwebview ".addons.qtwebview")
...
if (qt_platform STREQUAL "windows_x86")
  ...
  foreach (qt_component IN ITEMS qtbase qtdeclarative qtsvg qttools qtmultimedia qt5compat qtwebchannel qtwebsockets qtwebview qttranslations)
    list(APPEND qt_files
      "qt.qt6.${qt_version_nodot}${qt_addon_directory_for_${qt_component}}.${qt_abi}/${qt_file_name_prefix}${qt_component}-Windows-Windows_11_23H2-MSVC2022-Windows-Windows_11_23H2-X86_64.7z")
  endforeach ()
...
elseif (qt_platform STREQUAL "mac_x64")
  ...
  foreach (qt_component IN ITEMS qtbase qtdeclarative qtsvg qttools qtmultimedia qt5compat qtwebchannel qtwebsockets qtwebview qttranslations)
    list(APPEND qt_files
      "qt.qt6.${qt_version_nodot}${qt_addon_directory_for_${qt_component}}.${qt_abi}/${qt_file_name_prefix}${qt_component}-MacOS-MacOS_14-Clang-MacOS-MacOS_14-X86_64-ARM64.7z")
  endforeach ()
...
elseif (qt_platform STREQUAL "linux_x64")
  ...
  foreach (qt_component IN ITEMS qtbase qtdeclarative qtsvg qttools qtmultimedia qt5compat qtwebchannel qtwebsockets qtwebview qttranslations)
    list(APPEND qt_files
      "qt.qt6.${qt_version_nodot}${qt_addon_directory_for_${qt_component}}.${qt_abi}/${qt_file_name_prefix}${qt_component}-Linux-RHEL_8_10-GCC-Linux-RHEL_8_10-X86_64.7z")
  endforeach ()
  list(APPEND qt_files
