...
class VTK_EXPORT vtkPrismCubeAxesRepresentation : public vtkPVDataRepresentation
{
public:
  static vtkPrismCubeAxesRepresentation* New();
  vtkTypeMacro(vtkPrismCubeAxesRepresentation, vtkPVDataRepresentation);
  ...
  // Description:
  // This needs to be called on all instances of vtkPrismCubeAxesRepresentation when
...
protected:
  ...
  vtkPrismCubeAxesActor* CubeAxesActor;
  double Position[3];
  double Scale[3];
