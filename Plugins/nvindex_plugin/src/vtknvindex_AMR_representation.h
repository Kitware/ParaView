...
#ifndef VTKNVINDEX_AMR_REPRESENTATION_H
#define VTKNVINDEX_AMR_REPRESENTATION_H
...
class VTK_EXPORT vtknvindex_AMR_representation : public vtkPVDataRepresentation
{
public:
  static vtknvindex_AMR_representation* New();
  vtkTypeMacro(vtknvindex_AMR_representation, vtkPVDataRepresentation);
...
private:
  vtknvindex_AMR_representation(const vtknvindex_AMR_representation&);
  void operator=(const vtknvindex_AMR_representation&);
