...
=========================================================================*/
#include "vtkOpenVRWebView.h"

#include "ui_vtkOpenVRWebView.h"
...
class vtkOpenVRWebView::pqInternals : public Ui::vtkOpenVRWebView
{
};

void vtkOpenVRWebView::constructor()
{
  this->setWindowTitle("vtkOpenVRWebView");
...
vtkOpenVRWebView::~vtkOpenVRWebView()
{
  delete this->Internals;
}

void vtkOpenVRWebView::SendTab()
{
...
void vtkOpenVRWebView::SetInputText(std::string const& val)
{
  if (!val.length())
  {
    return;
...
void vtkOpenVRWebView::loadURL(std::string const& url)
{
  this->loadURL(QUrl::fromUserInput(url.c_str()));
}

void vtkOpenVRWebView::loadURL(QUrl url)
{
