...
vtkTransformPolyDataFilter* transformHill(vtkParametricFunctionSource* source,
                                          bool isBack=false);
vtkParametricFunctionSource* getRandomHill(double umin, double umax,
                                 double vmin, double vmax);
vtkMapper* generateSidePolygon(vtkParametricFunctionSource* source,
                               bool isLower, const char* side);
