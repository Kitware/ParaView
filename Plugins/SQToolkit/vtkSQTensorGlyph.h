...
=========================================================================*/
// .NAME vtkSQTensorGlyph - scale and orient glyph(s) according to tensor eigenvalues and eigenvectors
// .SECTION Description
// vtkSQTensorGlyph is a filter that copies a geometric representation
...
private:
  vtkSQTensorGlyph(const vtkSQTensorGlyph&);  // Not implemented.
  void operator=(const vtkSQTensorGlyph&);  // Not implemented.
};
