      ...
      pqAutoGeneratedObjectPanel(l_proxy,l_parent)
{
  ...
  vtkSMProxy *prxy=this->proxy();
  pqPropertyManager *propMgr=this->propertyManager();
  pqNamedWidgets::unlinkObject(this->BlockSize,prxy,"BlockSize",propMgr);
  pqNamedWidgets::unlinkObject(this->BlockCacheSize,prxy,"BlockCacheSize",propMgr);
...
void pqSQBOVMetaReader::UpdateNoBlocksCachedValidator()
{
  ...
  this->NoBlocksToCache->setValidator(new QIntValidator(1,(int)nBlocks,this));
}
