 ...
 *                        RCS Information                                    *
 *                                                                           *
 * $Source: /homedir/cvs/Nektar/Utilities/src/uyy.C,v $
 * $Revision: 1.2 $
...
char *prog   = "uyy";
char *usage  = "uyy:  [options]  -r file[.rea]  input[.fld]\n";
char *author = "";
char *rcsid  = "";
char *help   =
...
static void Calc_Vort (FileList *f, Element_List **U, int nfields){
  ...
  U[0]->flist[k]->Grad_d(0, Uy, 0, 'y');
  dcopy(qt,Uy,1,*U[nfields]->flist[k]->h,1);
