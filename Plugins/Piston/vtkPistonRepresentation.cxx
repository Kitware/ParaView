...
{
  vtkPistonDataObject* input =
    vtkPistonDataObject::SafeDownCast(this->GetInputDataObject(0, 0));
  if (input)
    {
...
//----------------------------------------------------------------------------
int vtkPistonRepresentation::FillInputPortInformation(
...
//----------------------------------------------------------------------------
int vtkPistonRepresentation::RequestUpdateExtent(vtkInformation* request,
...
//----------------------------------------------------------------------------
int vtkPistonRepresentation::RequestData(vtkInformation* request,
