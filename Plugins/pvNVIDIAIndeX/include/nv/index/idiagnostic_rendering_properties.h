...
class IDiagnostic_rendering_properties
  : public mi::base::Interface_declare<0xd0c69d46, 0x9511, 0x4285, 0x85, 0x3e, 0xb1, 0xb2, 0x70,
      0x99, 0x45, 0xe7, nv::index::IAttribute>
{
public:
  ...
  enum Property
  {
    ...
    OPACITY_FRONT, ///< [float]    (1)     Opacity factor of front (near) surfaces of subregion
                   /// boxes.
    ...
    ITEM_LIMIT,    ///< [int]      (0)     Limit number of subregions rendered (per device), 0 ==
                   /// unlimited.
    ///<                    If negative, then animate limit range from 1 to value, using
    /// FRAME_CYCLE.
    ITEM_START,  ///< [int]      (0)     Index of first subregion rendered (per device).
    FRAME_CYCLE, ///< [int]      (0)     Switch ITEM_LIMIT after number of frames, when animating
                 /// ITEM_LIMIT.
