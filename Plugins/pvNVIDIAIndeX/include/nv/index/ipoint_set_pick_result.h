 ...
 *****************************************************************************/
/// \file
/// \brief Point set specific pick results returned by the NVIDIA IndeX library when querying a
...
class IPoint_set_pick_result
  : public mi::base::Interface_declare<0x22be608a, 0x48da, 0x4c6a, 0xa7, 0xb7, 0x5e, 0x5c, 0xa3,
      0x66, 0x15, 0x99, nv::index::IScene_pick_result>
{
public:
