...
public:
    ...
    ///
    /// \return                     Returns the wireframe topology. The default is WIREFRAME_TOPOLOGY_QUADS.
    ///
    ...
    /// Get the current wireframe resolution. N times the resolution of the heightfield mesh resolution
    ///
