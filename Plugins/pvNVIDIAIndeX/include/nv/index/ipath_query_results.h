 ...
 *****************************************************************************/
/// \file
/// \brief Path specific query results returned by the NVIDIA IndeX library when querying a scene's
/// contents, e.g., using the pick operation.
...
///
class IPath_pick_result : public mi::base::Interface_declare<0x48da609d, 0x1f76, 0x4a53, 0x91, 0x06,
                            0x92, 0x26, 0xdf, 0x3e, 0x86, 0x7c, nv::index::IScene_pick_result>
{
public:
...
class IPath_lookup_result
  : public mi::base::Interface_declare<0x44666ae9, 0x28b3, 0x4f79, 0xb5, 0x63, 0x2d, 0x02, 0xba,
      0xdc, 0xf3, 0x15, nv::index::IScene_lookup_result>
{
public:
