...
#include <nv/index/isubdivision.h>
...
/// The \e session represents the entire workspace with the NVIDIA IndeX environment.
...
public:
    ...
    ///
    /// \todo The traversal order such as depth or breadth first shall be provided by the
    ...
    ///////////////////////////////////////////////////////////////////////////////////
    /// \name Spatial subdivision.
    ///@{

    /// Returns the spatial subdivision. 
    ///
    /// This can be used to store the subdivision generated by IndeX,
    /// and restore it by using \c set_affinity_information() to avoid costly internal regeneration.
    /// The returned object can be a basic \c ISubdivision or \c ISubdivision_topology.
    /// \c ISubdivision_topology contains the Kd-tree or Octree topology.
    ///
    /// \param[in]   dice_transaction     The DiCE transaction.
    ///
    /// \return New object with subdivision information (caller gets ownership), or nullptr. 
    ///
    virtual ISubdivision* get_spatial_subdivision(
        mi::neuraylib::IDice_transaction*   dice_transaction) const = 0;
    ...
    /// \param[in] dice_transaction  DiCE transaction to use.
    //
    virtual void export_scene_element(
