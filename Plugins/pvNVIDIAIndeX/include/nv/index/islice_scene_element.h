...
///
class ISlice_scene_element : public mi::base::Interface_declare<0xcc8eccf3, 0x7a53, 0x4b4c, 0x80,
                               0x7e, 0x47, 0x92, 0x4d, 0x27, 0xaa, 0x28, nv::index::IShape>
{
public:
...
class ISection_scene_element
  : public mi::base::Interface_declare<0xcb0e44c4, 0xe8c6, 0x4533, 0x9b, 0xc0, 0x0e, 0xf7, 0xf9,
      0x2e, 0xac, 0xba, nv::index::ISlice_scene_element>
{
public:
...
class IVertical_profile_scene_element
  : public mi::base::Interface_declare<0xff52984a, 0xc189, 0x451c, 0x80, 0x22, 0xc2, 0xc4, 0x8b,
      0xb6, 0x31, 0xae, nv::index::ISlice_scene_element>
{
public:
  ...
  virtual void append_vertex(const mi::math::Vector_struct<mi::Float32, 2>& vertex) = 0;
  ...
  virtual void get_vertex(
    mi::Uint32 index, mi::math::Vector_struct<mi::Float32, 2>& vertex) const = 0;
  ...
  virtual void set_vertex(
    mi::Uint32 index, const mi::math::Vector_struct<mi::Float32, 2>& vertex) = 0;
};
}
} // namespace index / nv
