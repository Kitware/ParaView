...
class IRegular_volume_rendering_properties
  : public mi::base::Interface_declare<0x89f2350b, 0xf1d9, 0x4924, 0x92, 0x92, 0x64, 0x74, 0xea,
      0xb5, 0x12, 0xd0, nv::index::IAttribute>
{
public:
  ...
  enum Shading_mode
  {
    ...
    PHONG_MATERIAL_LIGHTING ///< Basic Lambertian diffuse reflectance with Blinn-Phong specular
                            /// lighting
