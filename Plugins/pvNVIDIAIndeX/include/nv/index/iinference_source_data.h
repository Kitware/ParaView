...
class IInference_source_data :
    public mi::base::Interface_declare<0xe455b9a0,0x9b5c,0x4acb,0xb6,0xcf,0x31,0x4b,0x36,0x70,0x3a,0xa7>
{
public:
    ...
    ///
    /// \return     Returns the bounding box of the subregion that is defined in the subdivision space.
    ///
    ...
    /// Subregions typically only store part subset of the entire distributed data. An inference technique
