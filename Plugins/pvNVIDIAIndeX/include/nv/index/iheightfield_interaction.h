...
class IHeightfield_interaction :
    public mi::base::Interface_declare<0x6bf54fd7,0x65cb,0x4f88,0x8c,0x19,0x6f,0xe7,0x07,0x81,0x2e,0x83>
{
public:
    ...
    virtual void pick(
        ...
        mi::neuraylib::Tag_struct                       volume_tag,
    ...
    virtual void pick(
        const mi::math::Vector_struct<mi::Uint32, 2>&   pixel_location,
        const nv::index::IIndex_canvas*                 pick_canvas,
        mi::neuraylib::Tag_struct                       slice_scene_element,
        mi::neuraylib::Tag_struct                       volume_tag,
        ISnapping_algorithm*                            snapping_algorithm,
        mi::neuraylib::IDice_transaction*               dice_transaction) const = 0;
    ...
    virtual void invoke_computing(
        IDistributed_compute_algorithm*                 distributed_compute_algorithm,
        mi::neuraylib::IDice_transaction*               dice_transaction) const = 0;
};
