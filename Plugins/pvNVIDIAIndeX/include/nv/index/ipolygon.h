...
class IPolygon : public mi::base::Interface_declare<0x6558d81b, 0xe2de, 0x4349, 0x92, 0xcf, 0x86,
                   0xd2, 0x27, 0x1b, 0x3b, 0xfc, nv::index::IImage_space_shape>
...
public:
  ...
  ///
  virtual bool set_geometry(const mi::math::Vector_struct<mi::Float32, 2>* verts,
    mi::Uint32 nb_verts, const mi::math::Vector_struct<mi::Float32, 3>& center) = 0;
  ...
  ///
  virtual void get_geometry(mi::math::Vector_struct<mi::Float32, 2>** verts, mi::Uint32& nb_verts,
