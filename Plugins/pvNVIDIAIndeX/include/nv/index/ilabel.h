...
public:
    ...
    virtual void get_color(
        mi::math::Color_struct& foreground,
        mi::math::Color_struct& background) const = 0;
    ...
    virtual void set_color(
        const mi::math::Color_struct& foreground,
...
public:
    ...
    /// an anchor point that lies inside plane that the label lies in and defines the label's lower left corner,
    ...
    ///                             in local space. If the width is not set (or set to a negative value)
    ...
    /// The position and orientation in object space is defined by
    /// an anchor point that lies inside plane the label lies in and defines the label's lower left corner,
...
public:
    ...
    ///
    /// \param[in] height           The height of the label along the up vector
    ///                             in image space. The size is defined in the 2D image space. (pixels)
    ///
    /// \param[in] width            The width of the label along the right vector 
    ///                             in image space. If the width is not set (or set to a negative value)
    ///                             then the width of the label will be computed automatically by the 
    ///                             rendering system. The size is defined in the 2D image space. (pixels)
    ///
    virtual void set_geometry(
        const mi::math::Vector_struct<mi::Float32, 3>& position,
