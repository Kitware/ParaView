 ...
 *****************************************************************************/
/// \file
/// \brief Triangle mesh specific query results returned by the NVIDIA IndeX library when querying a
/// scene's contents.
...
class ITriangle_mesh_pick_result
  : public mi::base::Interface_declare<0xe2697b96, 0xdd49, 0x4506, 0x81, 0x57, 0x40, 0x31, 0x96,
      0x43, 0x0e, 0x2f, nv::index::IScene_pick_result>
{
public:
  /// Returns triangle index of the hit triangle. The triangle index is defined globally in the
  /// triangle mesh
  /// regardless of the machine where the triangle of the triangle mesh is stored and rendered.
  /// The global triangle index allows querying the triangle's specific details using NVIDIA IndeX's
  /// lookup
...
class ITriangle_mesh_lookup_result
  : public mi::base::Interface_declare<0xd91ca5a9, 0x8222, 0x42ec, 0xab, 0x44, 0x65, 0xd1, 0x72,
      0xad, 0x0b, 0x71, nv::index::IScene_lookup_result>
{
public:
  /// Each triangle of a triangle mesh is defined by 3 vertices with their locations defined in the
  /// triangle mesh's 3D space.
  ...
  ///
  virtual void get_vertices(mi::math::Vector_struct<mi::Float32, 3>& v0,
  ...
  ///
  virtual void get_normals(mi::math::Vector_struct<mi::Float32, 3>& n0,
  ...
  virtual void get_colors(
    mi::math::Color_struct& c0, mi::math::Color_struct& c1, mi::math::Color_struct& c2) const = 0;
  ...
  ///
  virtual void get_texture_coordinates(mi::math::Vector_struct<mi::Float32, 2>& st0,
