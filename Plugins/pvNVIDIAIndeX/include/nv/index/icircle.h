...
/// Such additional scene elements, which include for instance the following 2D circle, integrate
/// seamlessly
...
/// A 2D circle represents a screen-space shape commonly used to annotating a scene or to build
/// widgets.
/// The circle is defined in image space, i.e., a circle is parallel to the view plane and always
/// faces
/// towards the viewer.
///
class ICircle : public mi::base::Interface_declare<0xf5617675, 0x23cc, 0x4f82, 0xbc, 0xf7, 0x24,
                  0x52, 0x7e, 0xd6, 0xf7, 0xe5, nv::index::IImage_space_shape>
{
public:
  ...
  virtual void set_geometry(
    const mi::math::Vector_struct<mi::Float32, 3>& center, mi::Float32 radius) = 0;
  ...
  virtual void get_geometry(
    mi::math::Vector_struct<mi::Float32, 3>& center, mi::Float32& radius) const = 0;
