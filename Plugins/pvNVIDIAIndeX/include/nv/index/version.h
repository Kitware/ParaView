...
#define NVIDIA_INDEX_LIBRARY_VERSION_QUALIFIED_STRING "2.2-beta"
...
#define NVIDIA_INDEX_LIBRARY_VERSION_QUALIFIER "beta"
...
#define NVIDIA_INDEX_LIBRARY_REVISION_STRING "327600.223"

/// Major (branch) number of NVIDIA IndeX revision.
#define NVIDIA_INDEX_LIBRARY_REVISION_MAJOR 327600

/// Minor number of NVIDIA IndeX revision. May be 0 if there is no minor revision.
#define NVIDIA_INDEX_LIBRARY_REVISION_MINOR 223
