...
public:
  ...
  ///
  /// \param[in]  elements
  ///             The number of elements of a given type (type size) to be hosted in allocated
  ///             device memory.
  ///
  /// \param[in]  type_size
  ///             The size of type of each of the elements that shall be stored in the allocated
  ///             device memory.
  ///
  /// \returns    Returns the requested CUDA device buffer encapsulated in an instance of \c
  /// ICuda_memory_buffer.
  ///
...
{
public:
  /// Requesting a CUDA device memory manager eanbles allocation of NVIDIA IndeX-managed CUDA device
  /// memory.
  ///
