...
/// \endif
class ITransaction : public mi::base::Interface_declare<0x6ca1f0c2, 0xb262, 0x4f09, 0xa6, 0xa5,
                       0x05, 0xae, 0x14, 0x45, 0xed, 0xfa>
{
public:
  ...
  virtual IArray* list_elements(
    const char* root_element, const char* name_pattern = 0, const IArray* type_names = 0) const = 0;
