...
class IDice_configuration : public mi::base::Interface_declare<0xfccbf7b8, 0x30d1, 0x4fbf, 0xbd,
                              0xc6, 0x3b, 0x96, 0xe1, 0xfb, 0x40, 0x6a>
{
public:
...
class ITag_set : public mi::base::Interface_declare<0xb8290f90, 0x3692, 0x4bb9, 0x87, 0x22, 0x45,
                   0x4a, 0xd6, 0xf1, 0x1f, 0xf5>
{
public:
...
class IDice_transaction : public mi::base::Interface_declare<0x1885cbec, 0x3cfc, 0x4f9d, 0xb2, 0xe9,
                            0xb2, 0xbe, 0xdc, 0xc8, 0x94, 0x88>
{
public:
  ...
  ///       \p tag.
  virtual Tag_struct store(IElement* element, Tag_struct tag = NULL_TAG, const char* name = 0,
  ...
  ///       element/job with that name. The tag of that database element/job is used instead of
  ///       \p tag.
  virtual Tag_struct store(IJob* job, Tag_struct tag = NULL_TAG, const char* name = 0,
    Privacy_level privacy_level = LOCAL_SCOPE) = 0;
  ...
  virtual Tag_struct store_for_reference_counting(IElement* element, Tag_struct tag = NULL_TAG,
    const char* name = 0, Privacy_level privacy_level = LOCAL_SCOPE) = 0;
  ...
  ///
  /// \see #store() for details
  virtual Tag_struct store_for_reference_counting(IJob* job, Tag_struct tag = NULL_TAG,
    const char* name = 0, Privacy_level privacy_level = LOCAL_SCOPE) = 0;
...
class IScheduler : public mi::base::Interface_declare<0xd0754018, 0xca8f, 0x48e0, 0x8a, 0x37, 0xeb,
                     0x83, 0x31, 0xb7, 0x85, 0x20>
{
public:
...
class IElement : public mi::base::Interface_declare<0x3f377a88, 0xb7aa, 0x487b, 0x98, 0xe6, 0x70,
                   0x53, 0xc2, 0xfa, 0xb9, 0xc9, neuraylib::ISerializable>
{
public:
...
class IJob : public mi::base::Interface_declare<0x0edda67e, 0x8e93, 0x4d41, 0xa8, 0xdb, 0x58, 0x5d,
               0x08, 0xfd, 0xb1, 0xde, neuraylib::ISerializable>
{
public:
...
class IExecution_listener : public mi::base::Interface_declare<0x5700dbde, 0xbe1d, 0x4c07, 0xa7,
                              0x0d, 0xf4, 0x11, 0x7e, 0x9f, 0x73, 0xf1>
{
public:
...
///      implementation of this abstract interface.
class IFragmented_job : public mi::base::Interface_declare<0x037f3783, 0x187c, 0x4bb7, 0x92, 0x50,
                          0x6d, 0xfe, 0x1c, 0x81, 0x89, 0xef, neuraylib::ISerializable>
{
public:
  ...
  virtual void execute_fragment(IDice_transaction* transaction, Size index, Size count,
  ...
  virtual void execute_fragment_remote(ISerializer* serializer, IDice_transaction* transaction,
    Size index, Size count, const IJob_execution_context* context) = 0;
  ...
  virtual void receive_remote_result(
    IDeserializer* deserializer, IDice_transaction* transaction, Size index, Size count) = 0;
  ...
  virtual IRDMA_buffer* execute_fragment_remote_rdma(IDice_transaction* transaction, Size index,
    Size count, IRDMA_context* rdma_context, const IJob_execution_context* context) = 0;
  ...
  virtual void receive_remote_result_rdma(
    IRDMA_buffer* buffer, IDice_transaction* transaction, Size index, Size count) = 0;
...
template <Uint32 id1, Uint16 id2, Uint16 id3, Uint8 id4, Uint8 id5, Uint8 id6, Uint8 id7, Uint8 id8,
  Uint8 id9, Uint8 id10, Uint8 id11, class I = base::IInterface>
...
/// methods themselves.
template <Uint32 id1, Uint16 id2, Uint16 id3, Uint8 id4, Uint8 id5, Uint8 id6, Uint8 id7, Uint8 id8,
  Uint8 id9, Uint8 id10, Uint8 id11, class I = IElement>
...
public:
  ...
  /// Destructor
  ~Element() { mi_base_assert(m_pointer == 0); }
...
/// methods themselves.
template <Uint32 id1, Uint16 id2, Uint16 id3, Uint8 id4, Uint8 id5, Uint8 id6, Uint8 id7, Uint8 id8,
  Uint8 id9, Uint8 id10, Uint8 id11, class I = IJob>
...
/// methods themselves.
template <Uint32 id1, Uint16 id2, Uint16 id3, Uint8 id4, Uint8 id5, Uint8 id6, Uint8 id7, Uint8 id8,
  Uint8 id9, Uint8 id10, Uint8 id11, class I = IFragmented_job>
...
public:
  ...
  virtual void execute_fragment_remote(ISerializer* serializer, IDice_transaction* transaction,
    Size index, Size count, const IJob_execution_context* context)
  {
    // avoid warnings
    (void)serializer;
    (void)transaction;
  ...
  /// Empty body. Not used since #get_scheduling_mode() requests local execution.
  virtual void receive_remote_result(
    IDeserializer* deserializer, IDice_transaction* transaction, Size index, Size count)
  {
    // avoid warnings
    (void)deserializer;
    (void)transaction;
  ...
  /// Empty body. Not used since #get_scheduling_mode() requests local execution.
  virtual IRDMA_buffer* execute_fragment_remote_rdma(IDice_transaction* transaction, Size index,
    Size count, IRDMA_context* rdma_context, const IJob_execution_context* context)
  {
    // avoid warnings
    (void)transaction;
    (void)index;
