...
/// </table>
class ILogger : public Interface_declare<0x4afbf19a, 0x5fb7, 0x4422, 0xae, 0x4b, 0x25, 0x13, 0x06,
                  0x2c, 0x30, 0x5f>
{
public:
  ...
  ///                          characters.
  inline void printf(Message_severity level, const char* module_category, const char* message, ...)
...
public:
  ...
  Log_streambuf(std::ostream& stream, ILogger* logger, const std::string& module_category,
...
public:
  ...
  /// \param default_level      The default log level. Used if no other log level is selected by
  ///                           one of the manipulators.
  Log_stream(ILogger* logger, const char* module_category,
    Message_severity default_level = MESSAGE_SEVERITY_INFO)
    : std::ostream(0)
  ...
  /// \param default_level      The default log level. Used if no other log level is selected by
  ///                           one of the manipulators.
  Log_stream(ILogger* logger, const std::string& module_category,
    Message_severity default_level = MESSAGE_SEVERITY_INFO)
    : std::ostream(0)
