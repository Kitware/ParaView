...
// # Summary:
// The same as "kernel_structured_volume_basic.cu" but inverts
// the RGB values as a negative.
...
public:
              ...
              Sample_output&     sample_output)
    {
        ...
        // store the negative output color
        sample_output.set_color(make_float4(1.f - sample_color.x, 1.f - sample_color.y, 1.f - sample_color.z, sample_color.w));
