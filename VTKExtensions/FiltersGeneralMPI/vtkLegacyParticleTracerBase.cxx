...
const double vtkLegacyParticleTracerBase::Epsilon = 1.0E-12;

using namespace vtkLegacyParticleTracerBaseNamespace;
using IDStates = vtkTemporalInterpolatedVelocityField::IDStates;

//------------------------------------------------------------------------------
vtkCxxSetObjectMacro(vtkLegacyParticleTracerBase, ParticleWriter, vtkAbstractParticleWriter);
vtkCxxSetObjectMacro(vtkLegacyParticleTracerBase, Integrator, vtkInitialValueProblemSolver);
...
#define ParticleTracerSetMacro(name, type)                                                         \
  void vtkLegacyParticleTracerBase::Set##name(type _arg)                                           \
  {                                                                                                \
    if (this->name == _arg)                                                                        \
    {                                                                                              \
      return;                                                                                      \
...
vtkLegacyParticleTracerBase::vtkLegacyParticleTracerBase()
{
  ...
  this->TerminalSpeed = vtkLegacyParticleTracerBase::Epsilon;
...
//------------------------------------------------------------------------------
vtkTypeBool vtkLegacyParticleTracerBase::ProcessRequest(
...
//------------------------------------------------------------------------------
int vtkLegacyParticleTracerBase::RequestInformation(vtkInformation* vtkNotUsed(request),
  vtkInformationVector** inputVector, vtkInformationVector* vtkNotUsed(outputVector))
{
  ...
  if (inInfo->Has(vtkStreamingDemandDrivenPipeline::TIME_STEPS()))
  {
    ...
    vtkDebugMacro(<< "vtkLegacyParticleTracerBase "
...
//------------------------------------------------------------------------------
int vtkLegacyParticleTracerBase::RequestUpdateExtent(vtkInformation* vtkNotUsed(request),
...
//------------------------------------------------------------------------------
void vtkLegacyParticleTracerBase::SetMeshOverTime(int meshOverTime)
{
...
//------------------------------------------------------------------------------
std::vector<vtkDataSet*> vtkLegacyParticleTracerBase::GetSeedSources(
...
//------------------------------------------------------------------------------
int vtkLegacyParticleTracerBase::UpdateDataCache(vtkDataObject* data)
{
...
//------------------------------------------------------------------------------
void vtkLegacyParticleTracerBase::TestParticles(
...
//------------------------------------------------------------------------------
void vtkLegacyParticleTracerBase::AssignSeedsToProcessors(double time, vtkDataSet* source,
...
//------------------------------------------------------------------------------
void vtkLegacyParticleTracerBase::AssignUniqueIds(
...
//------------------------------------------------------------------------------
void vtkLegacyParticleTracerBase::UpdateParticleList(ParticleVector& candidates)
{
...
//------------------------------------------------------------------------------
int vtkLegacyParticleTracerBase::ProcessInput(vtkInformationVector** inputVector)
{
...
{
  vtkLegacyParticleTracerBase* PT;
  double FromTime;
  bool Sequential;
  ...
  ParticleTracerFunctor(vtkLegacyParticleTracerBase* pt, double fromTime, bool sequential)
    : PT(pt)
    , FromTime(fromTime)
...
//------------------------------------------------------------------------------
vtkPolyData* vtkLegacyParticleTracerBase::Execute(vtkInformationVector** inputVector)
{
...
//------------------------------------------------------------------------------
int vtkLegacyParticleTracerBase::RequestData(
  vtkInformation* request, vtkInformationVector** inputVector, vtkInformationVector* outputVector)
{
...
//------------------------------------------------------------------------------
void vtkLegacyParticleTracerBase::IntegrateParticle(ParticleListIterator& it, double currentTime,
...
//------------------------------------------------------------------------------
bool vtkLegacyParticleTracerBase::ComputeDomainExitLocation(
...
//------------------------------------------------------------------------------
void vtkLegacyParticleTracerBase::CalculateVorticity(
...
//------------------------------------------------------------------------------
unsigned int vtkLegacyParticleTracerBase::NumberOfParticles()
{
  return static_cast<unsigned int>(this->ParticleHistories.size());
}

//------------------------------------------------------------------------------
void vtkLegacyParticleTracerBase::ResetCache()
{
...
//------------------------------------------------------------------------------
bool vtkLegacyParticleTracerBase::SetTerminationTimeNoModify(double t)
{
...
//------------------------------------------------------------------------------
void vtkLegacyParticleTracerBase::RenameGhostArray(vtkPointData* pd)
{
  if (!pd)
  {
    return;
...
//------------------------------------------------------------------------------
bool vtkLegacyParticleTracerBase::RetryWithPush(ParticleInformation& info, double* point1,
...
//------------------------------------------------------------------------------
void vtkLegacyParticleTracerBase::SetParticle(
  vtkLegacyParticleTracerBaseNamespace::ParticleInformation& info, double* velocity,
...
//------------------------------------------------------------------------------
bool vtkLegacyParticleTracerBase::IsPointDataValid(vtkDataObject* input)
{
...
//------------------------------------------------------------------------------
bool vtkLegacyParticleTracerBase::IsPointDataValid(
...
//------------------------------------------------------------------------------
void vtkLegacyParticleTracerBase::GetPointDataArrayNames(
...
//------------------------------------------------------------------------------
vtkFloatArray* vtkLegacyParticleTracerBase::GetParticleAge(vtkPointData* pd)
{
  return vtkArrayDownCast<vtkFloatArray>(pd->GetArray("ParticleAge"));
}

//------------------------------------------------------------------------------
vtkIntArray* vtkLegacyParticleTracerBase::GetParticleIds(vtkPointData* pd)
{
  return vtkArrayDownCast<vtkIntArray>(pd->GetArray("ParticleId"));
}

//------------------------------------------------------------------------------
vtkSignedCharArray* vtkLegacyParticleTracerBase::GetParticleSourceIds(vtkPointData* pd)
{
  return vtkArrayDownCast<vtkSignedCharArray>(pd->GetArray("ParticleSourceId"));
}

//------------------------------------------------------------------------------
vtkIntArray* vtkLegacyParticleTracerBase::GetInjectedPointIds(vtkPointData* pd)
{
  return vtkArrayDownCast<vtkIntArray>(pd->GetArray("InjectedPointId"));
}

//------------------------------------------------------------------------------
vtkIntArray* vtkLegacyParticleTracerBase::GetInjectedStepIds(vtkPointData* pd)
{
  return vtkArrayDownCast<vtkIntArray>(pd->GetArray("InjectionStepId"));
}

//------------------------------------------------------------------------------
vtkIntArray* vtkLegacyParticleTracerBase::GetErrorCodeArr(vtkPointData* pd)
{
  return vtkArrayDownCast<vtkIntArray>(pd->GetArray("ErrorCode"));
}

//------------------------------------------------------------------------------
vtkFloatArray* vtkLegacyParticleTracerBase::GetParticleVorticity(vtkPointData* pd)
{
  return vtkArrayDownCast<vtkFloatArray>(pd->GetArray("Vorticity"));
}

//------------------------------------------------------------------------------
vtkFloatArray* vtkLegacyParticleTracerBase::GetParticleRotation(vtkPointData* pd)
{
  return vtkArrayDownCast<vtkFloatArray>(pd->GetArray("Rotation"));
}

//------------------------------------------------------------------------------
vtkFloatArray* vtkLegacyParticleTracerBase::GetParticleAngularVel(vtkPointData* pd)
{
