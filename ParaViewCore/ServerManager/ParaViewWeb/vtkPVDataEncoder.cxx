...
//****************************************************************************
class vtkPVDataEncoder::vtkInternals
{
private:
...
vtkStandardNewMacro(vtkPVDataEncoder);
//----------------------------------------------------------------------------
vtkPVDataEncoder::vtkPVDataEncoder() :
...
//----------------------------------------------------------------------------
void vtkPVDataEncoder::Initialize()
{
  this->Internals->TerminateAllWorkers();
  this->Internals->SpawnWorkers();
}
...
//----------------------------------------------------------------------------
bool vtkPVDataEncoder::GetLatestOutput(
  vtkTypeUInt32 key, vtkSmartPointer<vtkUnsignedCharArray>& data)
{
...
//----------------------------------------------------------------------------
void vtkPVDataEncoder::Flush(vtkTypeUInt32 key)
{
...
//----------------------------------------------------------------------------
void vtkPVDataEncoder::PrintSelf(ostream& os, vtkIndent indent)
{
