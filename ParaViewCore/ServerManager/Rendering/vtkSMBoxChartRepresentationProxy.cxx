/*=========================================================================
  ...
  Program:   ParaView
  Module:    vtkSMBoxChartRepresentationProxy.cxx
...
=========================================================================*/
#include "vtkSMBoxChartRepresentationProxy.h"
...
vtkStandardNewMacro(vtkSMBoxChartRepresentationProxy);
//----------------------------------------------------------------------------
vtkSMBoxChartRepresentationProxy::vtkSMBoxChartRepresentationProxy()
{
}
...
//----------------------------------------------------------------------------
void vtkSMBoxChartRepresentationProxy::PrintSelf(ostream& os, vtkIndent indent)
{
  this->Superclass::PrintSelf(os, indent);
}

//----------------------------------------------------------------------------
void vtkSMBoxChartRepresentationProxy::UpdatePropertyInformationInternal(
