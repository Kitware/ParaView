...
//----------------------------------------------------------------------------
int vtkMarkSelectedRows::RequestDataObject( vtkInformation*,
  ...
  vtkInformationVector* outputVector)
{
  ...
  if (inputMB)
    ...
    bool nothing_extracted = extractedMB == NULL ||
      extractedMB->GetNumberOfBlocks() == 0;
    ...
    for (iter->InitTraversal(); !iter->IsDoneWithTraversal();
      ...
      if (curInput)
        ...
        vtkTable* curExtractedTable = nothing_extracted? NULL :
          vtkTable::SafeDownCast(extractedMB->GetDataSet(iter));
...
int vtkMarkSelectedRows::RequestDataInternal(vtkTable* input,
  vtkTable* extractedInput, vtkTable* output)
{
