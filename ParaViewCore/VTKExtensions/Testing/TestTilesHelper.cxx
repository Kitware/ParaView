  ...
  int minx,  int miny, int maxx, int maxy)
{
  ...
  cout << "---------------------" << endl << "Rank : " << rank << " in "
    << helper->GetTileDimensions()[0] << "x"
    << helper->GetTileDimensions()[1] << endl;
  cout << normalized_tile_viewport[0] << ", "
    << normalized_tile_viewport[1] << ", "
    << normalized_tile_viewport[2] << ", "
    << normalized_tile_viewport[3] << endl;

  int tile_viewport[4];
  helper->GetTileViewport(viewport, rank, tile_viewport);

  cout << "Expected value: " << minx << ", " << miny << ", "
    << maxx << ", " << maxy << endl;
  cout << "From vtkTilesHelper: "
