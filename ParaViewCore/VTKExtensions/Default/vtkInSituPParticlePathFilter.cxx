...
//---------------------------------------------------------------------------
int vtkInSituPParticlePathFilter::FillInputPortInformation(
...
void vtkInSituPParticlePathFilter::AddRestartSeeds(vtkInformationVector** inputVector)
{
  ...
  this->UseArrays = true;
  this->AssignSeedsToProcessors(this->GetCurrentTimeValue(), restartSeeds, 0, 0,
                                localRestartSeeds, localAssignedCount);
  this->UseArrays = false;
...
//---------------------------------------------------------------------------
void vtkInSituPParticlePathFilter::AssignSeedsToProcessors(
  ...
  ParticleVector &localSeedPoints, int &localAssignedCount)
{
  ...
  for (int i=0; i<numSeeds; i++)
    ...
    if(this->UseArrays)
      ...
      vtkCharArray* sourceId = vtkCharArray::SafeDownCast(
        pd->GetArray("ParticleSourceId"));
      info.SourceID = sourceId->GetValue(i);
      vtkIntArray* injectedPointId = vtkIntArray::SafeDownCast(
        pd->GetArray("InjectedPointId"));
      info.InjectedPointId = injectedPointId->GetValue(i);
      vtkIntArray* injectedStepId = vtkIntArray::SafeDownCast(
        pd->GetArray("InjectionStepId"));
      ...
      vtkIntArray* uniqueParticleId = vtkIntArray::SafeDownCast(
        pd->GetArray("ParticleId"));
