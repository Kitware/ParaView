...
//----------------------------------------------------------------------------
int vtkBoundedVolumeSource::RequestInformation(vtkInformation *,
  vtkInformationVector **, vtkInformationVector *outputVector)
{
  ...
  double spacing[3] = {
    this->Scale[0] / this->Resolution[0],
    this->Scale[1] / this->Resolution[1],
...
void vtkBoundedVolumeSource::PrintSelf(ostream& os, vtkIndent indent)
{
  ...
  os << indent << "Resolution: " << this->Resolution[0] << ", " << this->Resolution[1] << ", " << this->Resolution[2] << endl;
}
