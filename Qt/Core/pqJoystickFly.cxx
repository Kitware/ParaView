...
vtkStandardNewMacro(pqJoystickFly);
vtkCxxRevisionMacro(pqJoystickFly, "1.1");

//-------------------------------------------------------------------------
pqJoystickFly::pqJoystickFly()
{
  this->In = 1;
  this->FlyFlag = 0;
  this->FlySpeed = 20.0;
...
//-------------------------------------------------------------------------
void pqJoystickFly::OnButtonDown(int, int, vtkRenderer *ren,
...
//-------------------------------------------------------------------------
void pqJoystickFly::OnButtonUp(int, int, vtkRenderer*,
                                  vtkRenderWindowInteractor* rwi)
{
  this->FlyFlag = 0;
  rwi->Render();
...
//-------------------------------------------------------------------------
void pqJoystickFly::OnMouseMove(int, int, vtkRenderer*,
                                   vtkRenderWindowInteractor*)
{
}

//-------------------------------------------------------------------------
void pqJoystickFly::Fly(vtkRenderer* ren, vtkRenderWindowInteractor *rwi,
                           float, float ispeed)
{
  if ( this->FlyFlag )
    {
...
//-------------------------------------------------------------------------
void pqJoystickFly::ComputeCameraAxes(vtkRenderer* ren)
{
...
//-------------------------------------------------------------------------
void pqJoystickFly::PrintSelf(ostream& os, vtkIndent indent)
{
