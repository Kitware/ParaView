...
class VTKREMOTINGSERVERMANAGER_EXPORT vtkSMTrace : public vtkSMObject
{
public:
   ...
   */
  class TraceItem;
  class VTKREMOTINGSERVERMANAGER_EXPORT TraceItemArgs
  {
  public:
    TraceItemArgs();
    ~TraceItemArgs();
    ...
    TraceItemArgs& arg(const char* key, const std::vector<vtkObject*>& val);
  ...
  class VTKREMOTINGSERVERMANAGER_EXPORT TraceItem
  {
  public:
