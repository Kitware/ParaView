...
#include "vtkRemotingCoreModule.h" // needed for export macro

class VTKREMOTINGCORE_EXPORT vtkCompositeMultiProcessController : public vtkMultiProcessController
{
public:
