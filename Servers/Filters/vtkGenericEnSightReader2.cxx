/*=========================================================================
  ...
  Module:    vtkGenericEnSightReader2.cxx
...
#include "vtkEnSight6BinaryReader2.h"
#include "vtkEnSight6Reader2.h"
#include "vtkEnSightGoldBinaryReader2.h"
#include "vtkEnSightGoldReader2.h"
...
#include "vtkPEnSightGoldReader2.h"
...
//----------------------------------------------------------------------------
vtkGenericEnSightReader2::vtkGenericEnSightReader2()
{
  this->Reader = NULL;
  this->IS = NULL;
  this->IFile = NULL;
  ...
  this->SelectionObserver->SetCallback(
    &vtkGenericEnSightReader2::SelectionModifiedCallback);
...
//-----------------------------------------------------------------------------
int vtkGenericEnSightReader2::CanReadFile(const char *casefilename)
{
  vtkGenericEnSightReader2 *reader = vtkGenericEnSightReader2::New();
...
//----------------------------------------------------------------------------
int vtkGenericEnSightReader2::RequestData(
...
//----------------------------------------------------------------------------
void vtkGenericEnSightReader2::SetTimeValue(float value)
{
...
//----------------------------------------------------------------------------
int vtkGenericEnSightReader2::DetermineEnSightVersion(int quiet)
{
  ...
  if (strncmp(line, "FORMAT", 6) == 0)
    ...
    if (stringRead == 1)
      ...
      if (strncmp(subLine1,"ensight",7) == 0)
        ...
        if (strncmp(subLine2,"gold",4) == 0)
          ...
          if (strncmp(line, "GEOMETRY", 8) == 0)
            ...
            if (this->IFile == NULL)
              ...
              this->IFile = NULL;
              delete [] fileName;
              return vtkGenericEnSightReader2::ENSIGHT_GOLD_BINARY;
              } // end if IFile == NULL
            ...
            this->IFile = NULL;
            delete [] fileName;
            return vtkGenericEnSightReader2::ENSIGHT_GOLD;
        ...
        {
        return vtkGenericEnSightReader2::ENSIGHT_MASTER_SERVER;
        }
      ...
      if (strncmp(line, "GEOMETRY", 8) == 0)
        ...
        if (this->IFile == NULL)
          ...
          this->IFile = NULL;
          delete [] fileName;
          return vtkGenericEnSightReader2::ENSIGHT_6_BINARY;
          } // end if IFile == NULL
        ...
        this->IFile = NULL;
        delete [] fileName;
        return vtkGenericEnSightReader2::ENSIGHT_6;
        } // if we found the geometry section in the case file
      } // not ensight gold
...
//----------------------------------------------------------------------------
void vtkGenericEnSightReader2::SetCaseFileName(const char* fileName)
{
  char *endingSlash;
...
//----------------------------------------------------------------------------
int vtkGenericEnSightReader2::RequestInformation(
  ...
  vtkInformationVector *outputVector)
{
  ...
  int createReader = 1;
  if (version == vtkGenericEnSightReader2::ENSIGHT_6)
    {
    vtkDebugMacro("EnSight6");
    if (this->Reader)
      {
      if (strcmp(this->Reader->GetClassName(), "vtkEnSight6Reader2") == 0)
        {
        createReader = 0;
        }
      else
    ...
    if (createReader)
      {
      this->Reader = vtkEnSight6Reader2::New();
      }
    }
  else if (version == vtkGenericEnSightReader2::ENSIGHT_6_BINARY)
    {
    vtkDebugMacro("EnSight6 binary");
    if (this->Reader)
      {
      if (strcmp(this->Reader->GetClassName(), "vtkEnSight6BinaryReader2") == 0)
        {
        createReader = 0;
        }
      else
    ...
    if (createReader)
      {
      this->Reader = vtkEnSight6BinaryReader2::New();
      }
    }
  else if (version == vtkGenericEnSightReader2::ENSIGHT_GOLD)
    {
    ...
    if( this->GetMultiProcessNumberOfProcesses() < 2 )
      ...
      if (this->Reader)
        {
        if (strcmp(this->Reader->GetClassName(), "vtkEnSightGoldReader2") == 0)
          {
          createReader = 0;
          }
        else
        ...
        if (createReader)
          {
          this->Reader = vtkEnSightGoldReader2::New();
          }
      }
    else
      {
      ...
      if (this->Reader)
        {
        if (strcmp(this->Reader->GetClassName(), "vtkPEnSightGoldReader2") == 0)
          {
          createReader = 0;
          }
        else
  ...
  if (createReader)
          {
      this->Reader = vtkPEnSightGoldReader2::New();
      }
  }
    }
  else if (version == vtkGenericEnSightReader2::ENSIGHT_GOLD_BINARY)
    {
  ...
  if (createReader)
      {
      this->Reader = vtkEnSightGoldBinaryReader2::New();
      }
  }
    else
  {
  ...
  if (this->Reader)
      {
      if (strcmp(this->Reader->GetClassName(),
        "vtkPEnSightGoldBinaryReader2") == 0)
    {
    createReader = 0;
    }
      else
  ...
  if (createReader)
      {
      this->Reader = vtkPEnSightGoldBinaryReader2::New();
      }
  }
    }
  else
  ...
  // force vtkEnSightGoldBinaryReader2::ReadPartId(...) to determine
  ...
  // line and therefore would prevent vtkEnSightGoldBinaryReader2::
...
//----------------------------------------------------------------------------
void vtkGenericEnSightReader2::AddVariableDescription(const char* description)
{
...
//----------------------------------------------------------------------------
void vtkGenericEnSightReader2::AddComplexVariableDescription(const char* description)
{
  int i;
...
//----------------------------------------------------------------------------
int vtkGenericEnSightReader2::GetNumberOfVariables(int type)
{
  switch (type)
    {
    case vtkEnSightReader2::SCALAR_PER_NODE:
      return this->GetNumberOfScalarsPerNode();
    case vtkEnSightReader2::VECTOR_PER_NODE:
      return this->GetNumberOfVectorsPerNode();
    case vtkEnSightReader2::TENSOR_SYMM_PER_NODE:
      return this->GetNumberOfTensorsSymmPerNode();
    case vtkEnSightReader2::SCALAR_PER_ELEMENT:
      return this->GetNumberOfScalarsPerElement();
    case vtkEnSightReader2::VECTOR_PER_ELEMENT:
      return this->GetNumberOfVectorsPerElement();
    case vtkEnSightReader2::TENSOR_SYMM_PER_ELEMENT:
      return this->GetNumberOfTensorsSymmPerElement();
    case vtkEnSightReader2::SCALAR_PER_MEASURED_NODE:
      return this->GetNumberOfScalarsPerMeasuredNode();
    case vtkEnSightReader2::VECTOR_PER_MEASURED_NODE:
      return this->GetNumberOfVectorsPerMeasuredNode();
    case vtkEnSightReader2::COMPLEX_SCALAR_PER_NODE:
      return this->GetNumberOfComplexScalarsPerNode();
    case vtkEnSightReader2::COMPLEX_VECTOR_PER_NODE:
      return this->GetNumberOfComplexVectorsPerNode();
    case vtkEnSightReader2::COMPLEX_SCALAR_PER_ELEMENT:
      return this->GetNumberOfComplexScalarsPerElement();
    case vtkEnSightReader2::COMPLEX_VECTOR_PER_ELEMENT:
...
//----------------------------------------------------------------------------
const char* vtkGenericEnSightReader2::GetDescription(int n)
{
...
//----------------------------------------------------------------------------
const char* vtkGenericEnSightReader2::GetComplexDescription(int n)
{
...
//----------------------------------------------------------------------------
const char* vtkGenericEnSightReader2::GetDescription(int n, int type)
{
  int i, numMatches = 0;
...
//----------------------------------------------------------------------------
void vtkGenericEnSightReader2::AddVariableType(int variableType)
{
  int size;
  int i;
  int *types;
...
//----------------------------------------------------------------------------
void vtkGenericEnSightReader2::AddComplexVariableType(int variableType)
{
  int i;
  int* types = NULL;
  int size = this->NumberOfComplexVariables;
...
//----------------------------------------------------------------------------
int vtkGenericEnSightReader2::GetVariableType(int n)
{
  if (n < this->NumberOfVariables)
    {
...
//----------------------------------------------------------------------------
int vtkGenericEnSightReader2::GetComplexVariableType(int n)
{
  if (n < this->NumberOfComplexVariables)
    {
...
//----------------------------------------------------------------------------
int vtkGenericEnSightReader2::ReplaceWildcards(char* fileName, int timeSet,
                                              int fileSet)
{
...
//----------------------------------------------------------------------------
void vtkGenericEnSightReader2::ReplaceWildcardsHelper(char* fileName, int num)
{
...
//----------------------------------------------------------------------------
void vtkGenericEnSightReader2::SetByteOrderToBigEndian()
{
  this->ByteOrder = FILE_BIG_ENDIAN;
}

//----------------------------------------------------------------------------
void vtkGenericEnSightReader2::SetByteOrderToLittleEndian()
{
  this->ByteOrder = FILE_LITTLE_ENDIAN;
}

//----------------------------------------------------------------------------
const char *vtkGenericEnSightReader2::GetByteOrderAsString()
{
...
//----------------------------------------------------------------------------
void vtkGenericEnSightReader2::PrintSelf(ostream& os, vtkIndent indent)
{
...
//----------------------------------------------------------------------------
char** vtkGenericEnSightReader2::CreateStringArray(int numStrings)
{
...
//----------------------------------------------------------------------------
void vtkGenericEnSightReader2::DestroyStringArray(int numStrings,
                                                 char** strings)
{
  int i;
  for(i=0; i < numStrings; ++i)
...
//----------------------------------------------------------------------------
void vtkGenericEnSightReader2::SetDataArraySelectionSetsFromVariables()
{
...
//----------------------------------------------------------------------------
void vtkGenericEnSightReader2::SetDataArraySelectionSetsFromReader()
{
...
//----------------------------------------------------------------------------
void vtkGenericEnSightReader2::SetReaderDataArraySelectionSetsFromSelf()
{
  // Set the real reader's data array selections from ours.
...
//----------------------------------------------------------------------------
void vtkGenericEnSightReader2::SelectionModifiedCallback(vtkObject*,
                                                        unsigned long,
                                                        void* clientdata,
                                                        void*)
{
  static_cast<vtkGenericEnSightReader2*>(clientdata)->SelectionModified();
}

//----------------------------------------------------------------------------
void vtkGenericEnSightReader2::SelectionModified()
{
...
//----------------------------------------------------------------------------
int vtkGenericEnSightReader2::GetNumberOfPointArrays()
{
  return this->PointDataArraySelection->GetNumberOfArrays();
}

//----------------------------------------------------------------------------
const char* vtkGenericEnSightReader2::GetPointArrayName(int index)
{
  return this->PointDataArraySelection->GetArrayName(index);
}

//----------------------------------------------------------------------------
int vtkGenericEnSightReader2::GetPointArrayStatus(const char* name)
{
  return this->PointDataArraySelection->ArrayIsEnabled(name);
}

//----------------------------------------------------------------------------
void vtkGenericEnSightReader2::SetPointArrayStatus(const char* name, int status)
{
  if(status)
    {
...
//----------------------------------------------------------------------------
int vtkGenericEnSightReader2::GetNumberOfCellArrays()
{
  return this->CellDataArraySelection->GetNumberOfArrays();
}

//----------------------------------------------------------------------------
const char* vtkGenericEnSightReader2::GetCellArrayName(int index)
{
  return this->CellDataArraySelection->GetArrayName(index);
}

//----------------------------------------------------------------------------
int vtkGenericEnSightReader2::GetCellArrayStatus(const char* name)
{
  return this->CellDataArraySelection->ArrayIsEnabled(name);
}

//----------------------------------------------------------------------------
void vtkGenericEnSightReader2::SetCellArrayStatus(const char* name, int status)
{
  if(status)
    {
...
//----------------------------------------------------------------------------
int vtkGenericEnSightReader2::InsertNewPartId(int partId)
{
...
//----------------------------------------------------------------------------
int vtkGenericEnSightReader2::FillOutputPortInformation(int vtkNotUsed(port),
                                                       vtkInformation* info)
{
