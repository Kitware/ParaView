/*=========================================================================
  ...
  Module:    vtkGenericEnSightReader2.h
...
=========================================================================*/
// .NAME vtkGenericEnSightReader2 - class to read any type of EnSight files
// .SECTION Description
// The class vtkGenericEnSightReader2 allows the user to read an EnSight data
// set without a priori knowledge of what type of EnSight data set it is.

#ifndef __vtkGenericEnSightReader2_h
#define __vtkGenericEnSightReader2_h
...
class VTK_EXPORT vtkGenericEnSightReader2 : public vtkMultiBlockDataSetAlgorithm
{
public:
...
//THIB
vtkGenericEnSightReader2* GetReader() { return this->Reader; }


protected:
  vtkGenericEnSightReader2();
  ~vtkGenericEnSightReader2();
  ...
  istream* IS;
  FILE *IFile;
  vtkGenericEnSightReader2 *Reader;
...
private:
  vtkGenericEnSightReader2(const vtkGenericEnSightReader2&);  // Not implemented.
  void operator=(const vtkGenericEnSightReader2&);  // Not implemented.
};
