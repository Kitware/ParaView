/*=========================================================================
  ...
  Module:    TestTemporalCacheHierarchical.cxx
...
// to loop a composite source over T and pass Temporal data downstream.
//
...
//-------------------------------------------------------------------------
class vtkTemporalHierarchicalFractal : public vtkHierarchicalFractal {

public:
  static vtkTemporalHierarchicalFractal *New();
  vtkTypeRevisionMacro(vtkTemporalHierarchicalFractal, vtkHierarchicalFractal);
...
//  void GetTimeStepValues(vtkstd::vector<double> &steps);
 ...
 protected:
   vtkTemporalHierarchicalFractal();
...
//----------------------------------------------------------------------------
vtkCxxRevisionMacro(vtkTemporalHierarchicalFractal, "1.1");
vtkStandardNewMacro(vtkTemporalHierarchicalFractal);
//----------------------------------------------------------------------------
vtkTemporalHierarchicalFractal::vtkTemporalHierarchicalFractal()
{
...
//----------------------------------------------------------------------------
int vtkTemporalHierarchicalFractal::RequestInformation(
  vtkInformation* request,
  vtkInformationVector** inputVector,
  vtkInformationVector* outputVector)
{
...
//----------------------------------------------------------------------------
int vtkTemporalHierarchicalFractal::RequestData(
  vtkInformation* request,
  vtkInformationVector** inputVector,
  vtkInformationVector* outputVector)
{
...
public:
  ...
  { 
    ...
    vtkTemporalHierarchicalFractal *sph = vtkTemporalHierarchicalFractal::SafeDownCast(caller);
...
int main(int , char *[])
{
  ...
  vtkSmartPointer<vtkTemporalHierarchicalFractal> sphere = 
    vtkSmartPointer<vtkTemporalHierarchicalFractal>::New();
