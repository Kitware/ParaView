...
=========================================================================*/
// .NAME vtkEnSightReader2 - superclass for EnSight file readers

#ifndef __vtkEnSightReader2_h
#define __vtkEnSightReader2_h
...
class vtkEnSightReader2CellIdsType;
class vtkIdList;
class vtkMultiBlockDataSet;

class VTK_EXPORT vtkEnSightReader2 : public vtkGenericEnSightReader2
{
public:
  vtkTypeRevisionMacro(vtkEnSightReader2, vtkGenericEnSightReader2);
...
protected:
 ...
 int GetSectionType(const char *line);
  ...
  vtkEnSightReader2CellIdsType* CellIds;
...
private:
  vtkEnSightReader2(const vtkEnSightReader2&);  // Not implemented.
  void operator=(const vtkEnSightReader2&);  // Not implemented.
};
