                                            ...
                                            int *lowerLeftX, int *lowerLeftY)
{
  if (this->DisableIceT)
    {
    this->Superclass::GetTiledSizeAndOrigin(width, height, lowerLeftX,
      lowerLeftY);
    return;
    }
...
{
  if (!this->InIceTRender || this->DisableIceT)
    {
...
int vtkIceTRenderer::UpdateCamera()
{
  if (this->DisableIceT)
    {
    return this->Superclass::UpdateCamera();
    }
...
int vtkIceTRenderer::UpdateGeometry()
{
  if (this->DisableIceT)
    {
    return this->Superclass::UpdateGeometry();
    }
...
int vtkIceTRenderer::UpdateTranslucentPolygonalGeometry()
{
  if (this->DisableIceT)
    {
    return this->Superclass::UpdateTranslucentPolygonalGeometry();
    }
