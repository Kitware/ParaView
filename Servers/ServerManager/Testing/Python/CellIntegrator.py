...
# PolyLine
if paraview.IntegrateCell(reader2Output, 1) != 1.0:
    print "ERROR: incorrect result for cell 1 of 2nd dataset"
    sys.exit(1)

# Triangle
if paraview.IntegrateCell(reader2Output, 3) != 0.5:
    print "ERROR: incorrect result for cell 3 of 2nd dataset"
    sys.exit(1)

# Quad
if paraview.IntegrateCell(reader2Output, 5) != 1.0:
    print "ERROR: incorrect result for cell 5 of 2nd dataset"
    sys.exit(1)
...
# Tetrahedron
integVal = paraview.IntegrateCell(reader2Output, 7)
if integVal < 0.166 or integVal > 0.167:
    print "ERROR: incorrect result for cell 7 of 2nd dataset"
    sys.exit(1)

# Voxel
if paraview.IntegrateCell(reader2Output, 12) != 1.0:
    print "ERROR: incorrect result for cell 12 of 2nd dataset"
    sys.exit(1)
