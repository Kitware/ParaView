...
vtkCxxRevisionMacro(vtkSMCompositeDisplayProxy, "1.4");
//-----------------------------------------------------------------------------
...
//-----------------------------------------------------------------------------
void vtkSMCompositeDisplayProxy::InvalidateGeometryInternal()
{
  this->Superclass::InvalidateGeometryInternal();
