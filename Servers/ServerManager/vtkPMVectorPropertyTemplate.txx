...
vtkPMVectorPropertyTemplate<T, force_idtype>::vtkPMVectorPropertyTemplate()
{
...
//---------------------------------------------------------------------------
template <class T, class force_idtype>
bool vtkPMVectorPropertyTemplate<T, force_idtype>::Push(vtkSMMessage* message, int offset)
{
...
//---------------------------------------------------------------------------
template <class T, class force_idtype>
bool vtkPMVectorPropertyTemplate<T, force_idtype>::Pull(vtkSMMessage* message)
{
...
//---------------------------------------------------------------------------
template <class T, class force_idtype>
bool vtkPMVectorPropertyTemplate<T, force_idtype>::Push(T* values, int number_of_elements)
{
...
//---------------------------------------------------------------------------
template <class T, class force_idtype>
bool vtkPMVectorPropertyTemplate<T, force_idtype>::ReadXMLAttributes(
...
//----------------------------------------------------------------------------
template <class T, class force_idtype>
void vtkPMVectorPropertyTemplate<T, force_idtype>::PrintSelf(ostream& os, vtkIndent indent)
{
