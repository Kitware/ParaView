...
//-----------------------------------------------------------------------------
void vtkCPAdaptorAPI::RequestDataDescription(int* timeStep, double* time,
  int* coprocessThisTimeStep)
{
  ...
  if(vtkCPAdaptorAPI::CoProcessor->RequestDataDescription(
       vtkCPAdaptorAPI::CoProcessorData))
    {
