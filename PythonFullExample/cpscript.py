...
def CreatePipeline(datadescription):
  class Pipeline:
    ...
    ParallelPolyDataWriter1 = CreateCPWriter( XMLPPolyDataWriter, "slice_%t.pvtp", 10, cp_writers )

    SetActiveSource(Wavelet1)
    ParallelImageDataWriter1 = CreateCPWriter( XMLPImageDataWriter, "fullgrid_%t.pvti", 90, cp_writers )
