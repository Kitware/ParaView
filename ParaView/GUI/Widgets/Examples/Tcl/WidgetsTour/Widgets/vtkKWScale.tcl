proc vtkKWScaleEntryPoint {parent win} {
  ...
  set scale2 [vtkKWScaleWithEntry New]
  ...
  set scale2b [vtkKWScaleWithEntry New]
  ...
  set scale3 [vtkKWScaleWithEntry New]
  ...
  set scale_set [vtkKWScaleSet New]
