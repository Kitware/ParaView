...
public:
  ...
  void PlotOverTimeCheckButtonCallback(int state);
  int GetPlotOverTime();

  // Description:
  void LockTemporalCacheCheckButtonCallback(int state);
  ...
  void LegendPositionCallback(const char*);
...
protected:
  ...
  void PlotOverTimeInternal(int state);
