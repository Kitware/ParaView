...
vtkCxxRevisionMacro(vtkPVColorMap, "1.138");
...
//----------------------------------------------------------------------------
void vtkPVColorMap::NumberOfColorsScaleCallback(double value)
{
  this->SetNumberOfColors((int)value);
}
...
{
  this->SetScalarBarVisibility(this->ScalarBarCheck->GetSelectedState());
...
//----------------------------------------------------------------------------
void vtkPVColorMap::LockCheckCallback(int state)
{
  this->SetScalarRangeLock(state);
}
...
void vtkPVColorMap::SetScalarRangeLock(int val)
{
  ...
  this->ScalarRangeLockCheck->SetSelectedState(val);
  if ( ! val)
    {
...
void vtkPVColorMap::SetScalarBarVisibility(int val)
{
  ...
  if (val)
    {
    this->ScalarBarCheck->SetSelectedState(1);
    }
  else
    {
...
//----------------------------------------------------------------------------
void vtkPVColorMap::ScalarRangeWidgetCallback(double, double)
{
  double range[2];
...
void vtkPVColorMap::SetScalarRangeInternal(double min, double max)
{
  ...
  if (this->ScalarRange[0] > this->WholeScalarRange[0] ||
    ...
    {
    this->ScalarRangeLockCheck->SetSelectedState(1);
