/*=========================================================================
  ...
  Module:    vtkPVMesaRenderWindow.h
  Language:  C++
  Date:      $Date$
  Version:   $Revision$
...
=========================================================================*/
// .NAME vtkPVMesaRenderWindow - OpenGL rendering window
// .SECTION Description
// vtkPVMesaRenderWindow is a concrete implementation of the abstract class
...
#ifndef __vtkPVMesaRenderWindow_h
#define __vtkPVMesaRenderWindow_h
...
class VTK_EXPORT vtkPVMesaRenderWindow : public vtkRenderWindow
{
protected:
  //GLXContext ContextId;

  OSMesaContext ContextId;
  void *WindowId;
  void *NextWindowId;
  int OwnWindow;
...
public:
  static vtkPVMesaRenderWindow *New() {return new vtkPVMesaRenderWindow;};
  const char *GetClassName() {return "vtkPVMesaRenderWindow";};
  ...
  */
  ...
  // Description:
  // Dummy methods.
  void SetOffScreenRendering(int val) { val = val;}
  
protected:
  vtkPVMesaRenderWindow();
  ~vtkPVMesaRenderWindow();
  vtkPVMesaRenderWindow(const vtkPVMesaRenderWindow&) {};
  void operator=(const vtkPVMesaRenderWindow&) {};
