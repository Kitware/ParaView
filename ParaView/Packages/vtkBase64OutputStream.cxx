                                                ...
                                                unsigned char c2)
{
  ...
  unsigned char out[4];
  out[0] = this->Encode((c0 >> 2) & 0x3F);
  out[1] = this->Encode(((c0 << 4) & 0x30) | ((c1 >> 4) & 0x0F));
  out[2] = this->Encode(((c1 << 2) & 0x3C) | ((c2 >> 6) & 0x03));
  out[3] = this->Encode(c2 & 0x3F);
...
//----------------------------------------------------------------------------
const unsigned char vtkBase64OutputStream::EncodeTable[65] =
