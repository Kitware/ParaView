...
set pv(vtkTemp129) [$pv(vtkTemp98) GetPVWidget {Spacing}]
$pv(vtkTemp129) SetValue 0.1 0.1 0.1 0.01
...
set pv(vtkTemp195) [$pv(vtkTemp164) GetPVWidget {Spacing}]
$pv(vtkTemp195) SetValue 0.1 0.1 0.1 0.01
...
set pv(vtkTemp238) [$pv(vtkTemp207) GetPVWidget {Spacing}]
$pv(vtkTemp238) SetValue 0.1 0.1 0.1 0.01
...
set pv(vtkTemp281) [$pv(vtkTemp250) GetPVWidget {Spacing}]
$pv(vtkTemp281) SetValue 0.1 0.1 0.1 0.01
