...
set pv(vtkTemp181) [$pv(vtkTemp1) CreatePVSource vtkLoopSubdivisionFilter]
...
$pv(vtkTemp98) AcceptCallback
set pv(vtkTemp197) [$pv(vtkTemp1) CreatePVSource vtkShrinkPolyData]
...
set pv(vtkTemp220) [$pv(vtkTemp1) CreatePVSource vtkElevationFilter]
...
pvImageTest $DataDir/Baseline/Delete.png 10
